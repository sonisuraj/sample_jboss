app.controller('graphController', ['$scope','$http','$location','$rootScope','$interval','__env','callCount','Upload', '$timeout','$uibModal','$routeParams','$window',function($scope,$http,$location,$rootScope,$interval,__env,callCount,Upload, $timeout,$uibModal,$routeParams,$window) {
  console.log( $rootScope.mainGraph);
  console.log($routeParams);
  $scope.json = $window.sessionStorage.getItem('currentlydisplayedservice');
  $scope.json =(JSON.parse($scope.json));
  console.log($scope.json.nodes)
